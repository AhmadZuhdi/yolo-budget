...
export function TransactionFormDialog({ open, onClose, defaultType = 'expense' }: TransactionFormProps) {
  ...
  const [commitMode, setCommitMode] = useState<CommitMode>('stage')
      ...
      <DialogContent className="max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            <Label>Tags</Label>
            {/* Suggested tags for the current type */}
          ...
          >
            {commitMode === 'stage' ? 'Add to Staging' : 'Save Transaction'}
          </Button>
        </form>
      </DialogContent>
    </Dialog>
